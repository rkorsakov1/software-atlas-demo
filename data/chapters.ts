...
export const chapters: StoryChapter[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "[F] So far the money has landed mostly in infrastructure. Nvidia's revenue went from $27.0B in fiscal 2023 to $215.9B in fiscal 2026 (S28).",
  ...
  },
  {
    ...
    kicker: "19 candidates, six signals",
    body: [
      ...
      "[F] Six of the 19 candidates aren't about AI. They're driven by law or cost curves: mandatory e-invoicing, health-data APIs, battery prices down 90% since 2010, EU digital identity wallets.",
      "[F] Not every announced shift arrives. Facebook renamed itself Meta in 2021 to build the metaverse (S121) and put $21.40B into Reality Labs in 2025 alone (S122). That year headset shipments fell while display-less AI glasses sold more than 7 million units (S123, S124).",
